...
extension UILabel {
    ...
    open class TitleLabel: UIView, IconProperties, TitleLabelProperties {

        open class var ´default´: UILabel.TitleLabel {
            return UILabel.TitleLabel.create {
                $0.font = UIFont.boldSystemFont(ofSize: iphoneCompatible ? 13.5 : 19.0 )
                $0.iconSize = iphoneCompatible ? 15.0 : 22.0
        ...
        open var font: UIFont! {
            ...
            set {
                ...
                if self.hasIcon, ( self.iconSize == nil || self.iconColor == nil ) { self.refreshIcon() }
            }
        }
        ...
        open var iconMargin: CGFloat = iphoneCompatible ? 2.0 : 3.0 {
